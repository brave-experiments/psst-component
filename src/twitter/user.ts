...
export class TwitterUserScript implements UserScriptInterface {
    ...
    getUserId(): string | undefined {
        ...
        if (!twidCookie) {
          if (__DEV__) logger.error(`Cookie with name ${TWID_COOKIE_NAME} not found.`);
          return undefined;
        }
    ...
    getTasks(): UserScriptData | undefined {
        ...
        const userData: UserScriptData = {
            ...
            tasks: [
            {
                ...
                selector: '#react-root > div > div > div.css-175oi2r.r-1f2l425.r-13qz1uu.r-417010.r-18u37iz > main > div > div > div > section:nth-child(2) > div.css-175oi2r.r-qocrb3.r-14lw9ot.r-1h0z5md.r-1jx8gzb.r-f8sm7e.r-13qz1uu.r-1ye8kvj > div > div.css-175oi2r.r-w7s2jr.r-14lw9ot.r-3pj75a > div > label > div > div.css-175oi2r.r-lrvibr > input',
                turn_off: true,
            ...
            },
            {
                ...
                selector: '#react-root > div > div > div.css-175oi2r.r-1f2l425.r-13qz1uu.r-417010.r-18u37iz > main > div > div > div > section:nth-child(2) > div.css-175oi2r.r-qocrb3.r-14lw9ot.r-1h0z5md.r-1jx8gzb.r-f8sm7e.r-13qz1uu.r-1ye8kvj > div.css-175oi2r.r-w7s2jr.r-14lw9ot.r-3pj75a > div > div > label > div > div.css-175oi2r.r-lrvibr > input',
                turn_off: true,
                error_description: undefined
            },
            {
